/**
 * Backend NeDB — développement local ou Railway sans MongoDB
 */
...
if (process.env.DB_PATH) {
  ...
  console.warn('⚠️  NeDB dans /tmp — données éphémères. Ajoutez MONGODB_URI pour persister.');
} else {
...
console.log('📁 Base de données : NeDB →', dbPath);
module.exports = db;
